...
$chapterdata = mysql_query($chapterquery);

$currentrow = mysql_fetch_array($chapterdata);
...
<table align="center" cellpadding='10'>
  <tr>
    <td align='left' valign='top' >
	  ...
	  while ($currentchapterdata = mysql_fetch_array($chapterdata)) {
		  ...
		  $poemquery = mysql_query($sqlquery);
		  ...
		  while ($poeminfo = mysql_fetch_array($poemquery)) {
